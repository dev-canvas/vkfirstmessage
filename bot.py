...
def send_welcome_package(vk, user_id):
    ...
    message_text = (
        "🎉 Спасибо за подписку! Я подготовил для тебя полезный подарок — архив с материалами. "
        "Скачивай и используй! 👇\n\n"
...
def handle_button_click(vk, event):
    ...
    response_text = (
        ...
        "Вот подборка материалов по этой теме — скоро опубликуем в ленте, а пока держи чек-лист в карусели! 💛"
    )
